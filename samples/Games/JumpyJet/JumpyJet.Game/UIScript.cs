...
public class UIScript : SyncScript
{
    ...
    public override void Start()
    {
        unsafe
        {
            ...
            // GameWindowWinforms
            var handle = Game.Window.NativeWindow.Handle;
            Stride.Graphics.SDL.Window.SDL.SetWindowOpacity((Window*)handle, 0.8f);
            ...
            Console.WriteLine(Game.Window.NativeWindow.NativeWindow);


            Console.WriteLine("Window size: {0}x{1}", Game.Window.ClientBounds.Width, Game.Window.ClientBounds.Height);
    ...
    public override void Update()
    {
        ...
        if (pipePassedListener.TryReceive()) ++currentScore;
    ...
    private void CreateMainMenuUI()
    {
        ...
        var startButton = new Button { Content = new TextBlock { Font = Font, Text = "Touch to Start", TextColor = Color.Black, HorizontalAlignment = HorizontalAlignment.Center, VerticalAlignment = VerticalAlignment.Center }, NotPressedImage = buttonImage, PressedImage = buttonImage, MouseOverImage = buttonImage, Padding = new Thickness(77, 30, 25, 30), MinimumWidth = 250f, };
        ...
        mainMenuRoot = new ModalElement { HorizontalAlignment = HorizontalAlignment.Stretch, VerticalAlignment = VerticalAlignment.Stretch, Content = mainMenuCanvas };
    }

    private void CreateGameUI()
    {
        scoreTextBlock = new TextBlock { Font = Font, TextColor = Color.Black, VerticalAlignment = VerticalAlignment.Center };
        ...
        {
            BackgroundImage = SpriteFromSheet.Create(UIImages, "score_bg"), Content = scoreTextBlock, Padding = new Thickness(60, 31, 25, 35), MinimumWidth = 190f // Set the minimum width of score button so that it wont modify when the content (text) changes, and less than minimum.
        };
    ...
    {
        var menuButton = new Button { Content = new TextBlock { Font = Font, Text = "Menu", TextColor = Color.Black, HorizontalAlignment = HorizontalAlignment.Center, VerticalAlignment = VerticalAlignment.Center }, PressedImage = buttonImage, NotPressedImage = buttonImage, MouseOverImage = buttonImage, Padding = new Thickness(77, 30, 25, 30), MinimumWidth = 190f, };
        ...
        var retryButton = new Button { Content = new TextBlock { Font = Font, Text = "Retry", TextColor = Color.Black, HorizontalAlignment = HorizontalAlignment.Center, VerticalAlignment = VerticalAlignment.Center }, Padding = new Thickness(74, 30, 25, 30), MinimumWidth = 190f, PressedImage = buttonImage, MouseOverImage = buttonImage, NotPressedImage = buttonImage };
        ...
        gameOverRoot = new ModalElement { HorizontalAlignment = HorizontalAlignment.Stretch, VerticalAlignment = VerticalAlignment.Stretch, Content = gameOverCanvas };
    }
}
