...
//         public static Result Compute(IReadOnlyList<Vector3> vertices, float extrapolationDistance = 100.0f)
//         {
//             // Stores 4 additional vertices for the enclosing "super-tetrahedron"
//             // TODO: Another approach would be to receive a IList/Array directly and have a method GetVertexAtIndex(i) with special care for i in [vertices.Length; vertices.Length + 4[ range.
//             Span<Vector3> verticesSpan = stackalloc Vector3[vertices.Count + 4];
//
//             for (int i = 0 ; i < vertices.Count ; i++)
//             {
//                 verticesSpan[i] = vertices[i];
//             }
//
//             var tetrahedralization = new List<Tetrahedron>();
//             var freeTetrahedra     = new List<int>();
//
//             // Create super-tetrahedra that encompass everything
//             AddSuperTetrahedron(verticesSpan);
//
//             var badTetrahedra = new List<int>();
//             var holeFaces     = new List<HoleFace>();
...
//             /// </summary>
//             unsafe void AddSuperTetrahedron(Span<Vector3> verticesSpan)
//             {
//                 // Compute the bounding box of the primitive
//                 var boundingBox = BoundingBox.Empty;
//                 for (int i = 0 ; i < verticesSpan.Length ; i++)
//                 {
//                     BoundingBox.Merge(ref boundingBox, ref verticesSpan[i], out boundingBox);
//                 }
//
...
//                     verticesSpan[^4] = boundingBox.Minimum - boundingBox.Extent * 1000.0f;
//                     verticesSpan[^3] = boundingBox.Minimum + Vector3.UnitZ      * combinedSize * 1000.0f;
//                     verticesSpan[^2] = boundingBox.Minimum + Vector3.UnitY      * combinedSize * 1000.0f;
//                     verticesSpan[^1] = boundingBox.Minimum + Vector3.UnitX      * combinedSize * 1000.0f;
//
//                     // Create super tetrahedron
//                     var superTetrahedron = new Tetrahedron();
//                     for (int i = 0 ; i < 4 ; ++i)
//                     {
//                         superTetrahedron.Vertices[i]   = verticesSpan.Length - 4 + i;
//                         superTetrahedron.Neighbours[i] = -1; // No neighbour
//                     }
//
//                     if (!IsTetrahedronPositiveOrder(verticesSpan, ref superTetrahedron))
//                     {
...
//
//
//             static unsafe bool IsTetrahedronPositiveOrder(Span<Vector3> points, ref Tetrahedron tetrahedron)
//             {
//                 fixed (Tetrahedron* tetrahedronPointer = &tetrahedron)
//                 {
//                     return IsTetrahedronPositiveOrder2(
...
//             }
//
//             static bool IsTetrahedronPositiveOrder2(ref Vector3 a, ref Vector3 b, ref Vector3 c, ref Vector3 d)
//             {
...
//             }
//
//             unsafe void AddVertex(int vertexIndex)
//             {
...
//                     {
//                         if (IsTetrahedronAllocated(index) && IsPointInCircumsphere(ref vertex, vertices, ref tetrahedra[index])) badTetrahedra.Add(index);
//                     }
//
...
//
//                         if (!IsTetrahedronPositiveOrder(ref vertex, ref vertices[face -> Vertex0], ref vertices[face -> Vertex1], ref vertices[face -> Vertex2])) throw new InvalidOperationException();
//
...
//
//                         if (!IsTetrahedronPositiveOrder(vertices, ref *newTetrahedron)) throw new InvalidOperationException("Tetrahedron not in positive order");
//                     }
//                 }
//             }
//
//             unsafe bool IsTetrahedronAllocated(int index)
//             {
