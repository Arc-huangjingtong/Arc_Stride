...
/// <summary> The script system handles scripts scheduling in a game. </summary>
public sealed class ScriptSystem : GameSystemBase
{
    /// <summary> Initializes a new instance of the <see cref="GameSystemBase" /> class. </summary>
    ...
    public ScriptSystem(IServiceRegistry registry) : base(registry)
    {
        Enabled                   =  true;
